package dev.awe.atlas.listener;

import com.destroystokyo.paper.event.entity.EntityAddToWorldEvent;
import dev.awe.atlas.Atlas;
import dev.awe.atlas.api.event.pinata.PinataDeathEvent;
import dev.awe.atlas.api.event.pinata.PinataHitEvent;
import dev.awe.atlas.config.ConfigManager;
import dev.awe.atlas.config.settings.PinataConfig.ItemWhitelist;
...
import dev.awe.atlas.handler.HitCooldownHandler;
import dev.awe.atlas.handler.ReflexHandler;
...
public class PinataListener implements Listener {
    ...
    public PinataListener(Atlas plugin) {
        this.plugin = plugin;
