...
import dev.awe.atlas.behavior.PinataFleeGoal;
import dev.awe.atlas.behavior.PinataFloatGoal;
import dev.awe.atlas.behavior.PinataFreezeGoal;
import dev.awe.atlas.behavior.PinataRoamGoal;
...
public class BehaviorHandler {
    ...
    public BehaviorHandler(Atlas plugin) {
        this.plugin = plugin;
