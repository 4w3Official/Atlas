...
import dev.awe.atlas.config.objects.NameTagSettings;
import dev.awe.atlas.config.objects.NameTagSettings.*;
import dev.awe.atlas.config.objects.effects.*;
import java.io.File;
    ...
    public static class EventRegistry {
        ...
        public GameEvent hit = new GameEvent(
                ...
                new HashMap<>(Map.of(
                        "vip_reward",
                        new CommandAction(
                                50.0, false, false, false, "atlas.vip", List.of("give <player> diamond 1")))));
