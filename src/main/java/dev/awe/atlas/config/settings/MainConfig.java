package dev.awe.atlas.config.settings;

import de.exlll.configlib.*;
import dev.awe.atlas.config.objects.CommandAction;
import dev.awe.atlas.config.objects.SerializableLocation;
import dev.awe.atlas.config.objects.effects.EffectGroup;
import dev.awe.atlas.config.objects.effects.SoundEffect;
import java.io.File;
...
public final class MainConfig {
    ...
    public static class DatabaseSettings {
        ...
        @Comment("Prefix for tables (e.g., 'as_votes').")
        public String tablePrefix = "as_";
